...
/* user/new.html.twig */
class __TwigTemplate_a9cbda1b9779c209f7c2efaa37cf9084685ab71ed2c369fb8d17a6178781195c extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 8
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 8, $this->source); })()), 'form_start', ["attr" => ["id" => "new_edit_user"]]);
        echo "
        ...
        echo "
                ...
                <div class=\"col-12\">
                        ";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })()), "password", [], "any", false, false, false, 16), 'label');
        echo "
                        ";
        // line 17
...
";
    ...
    {
        return array (  132 => 27,  127 => 25,  123 => 24,  113 => 17,  109 => 16,  103 => 13,  99 => 12,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}", "user/new.html.twig", "/Users/devaz/Downloads/Symfony2021-WSF4A-master/templates/user/new.html.twig");
    }
}
