...
return [
    ...
    'post_all' => [[], ['_controller' => 'App\\Controller\\PostController::all'], [], [['text', '/post']], [], []],
    'post_read' => [['id'], ['_controller' => 'App\\Controller\\PostController::read'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/post']], [], []],
